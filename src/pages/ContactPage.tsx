import './home.css'
import { contact_banner, contact_bg, home_left } from '../assets'
                ...
                <MaxWidthWrapper className='relative z-20'>
                    ...
                    <div className="w-full flex flex-col sm:flex-row bg-[#281c0c]/30">
                        <div className="flex-1">
                            <img src={contact_banner} alt="contact banner" className='w-full h-full object-cover' />
                        </div>
                        <div className="flex-1 text-sm sm:text-base py-10 sm:px-10 lg:px-20 space-y-3 sm:space-y-6">
                            <div className="flex px-2 sm:px-0 items-center space-x-5 sm:space-x-10"><span className='text-stone-300'>Title:</span> <span className='font-medium sm:font-bold'>THE MYSTERY WORLD</span></div>
                            <div className="flex px-2 sm:px-0 items-center space-x-5 sm:space-x-10"><span className='text-stone-300'>Size:</span> <span className='font-medium sm:font-bold'>780 x 920</span></div>
                            <div className="flex px-2 sm:px-0 items-center space-x-5 sm:space-x-10"><span className='text-stone-300'>Medium:</span> <span className='font-medium sm:font-bold'>Water Based</span></div>
