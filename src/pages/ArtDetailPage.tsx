                        ...
                        <div className="flex-1 text-sm sm:text-base py-10 sm:px-10 lg:px-20 space-y-3 sm:space-y-6">
                            ...
                            <div className="rounded-md bg-black bg-opacity-[3%] dark:bg-stone-800/50 px-6 pt-4 pb-7">
                                ...
                                <form className='space-y-7 py-10'>
                                    <Input label='Email' className='bg-black bg-opacity-5 placeholder-stone-800 dark:placeholder-stone-500 dark:bg-black/20 focus:bg-stone-500/10 dark:focus:bg-white/10 border-b-stone-700 dark:border-stone-300' placeholder='example@gmail.com' />
