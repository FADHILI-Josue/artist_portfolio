...
const Navbar: FC = () => {
  ...
  return <div className="flex w-full justify-end md:justify-between my-16 text-zinc-700 font-semibold dark:text-zinc-400">
    <p className={cn('hidden md:inline-block', {'bg-gradient-to-r p-0 from-dark-gold via-light-gold to-black/30 bg-[length:100%_2px] bg-no-repeat bg-bottom': active === "/about"})}>ARTIST STATEMENT</p>
